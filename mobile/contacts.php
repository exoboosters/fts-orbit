...
//    var_dump($contacts);
    ...
    echo "<tr><th>Address:</th><td><input type='string' name='address' maxlength='97' required pattern='TA[123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz]{95}' value=''></td></tr>";
